...
$siteurl = $CFG->wwwroot;
    ...
    $string['HR_desc'] = 'Categories Block on the front page.<br /><img src="'.$siteurl.'/theme/space/doc/fp-block-cat.png" class="img-fluid rounded mt-3" />';

    $string['HR1'] = '<div class="d-block text-center"><br /><br />Block #1</div>';
    $string['HR1_desc'] = '3-Column HTML Block on the front page.<br /><img src="'.$siteurl.'/theme/space/doc/fp-block1.png" class="img-fluid rounded mt-3" />';

    $string['HR2'] = '<div class="d-block text-center"><br /><br />Block #2</div>';
    $string['HR2_desc'] = '2-column HTML Block on the front page.<br /><img src="'.$siteurl.'/theme/space/doc/fp-block2.png" class="img-fluid rounded mt-3" />';

    $string['HR3'] = '<div class="d-block text-center"><br /><br />Block #3</div>';
    $string['HR3_desc'] = 'Call to action block on the front page.<br /><img src="'.$siteurl.'/theme/space/doc/fp-block6.jpg" class="img-fluid rounded mt-3" /><br /><br />If you want to add some custom CSS just override this class <strong>.s-special-box-bg-gradient</strong>';

    $string['HR4'] = '<div class="d-block text-center"><br /><br />Block #4</div>';
    $string['HR4_desc'] = 'Single Column HTML Block on the front page.<br /><img src="'.$siteurl.'/theme/space/doc/fp-block4.png" class="img-fluid rounded mt-3" />';
    ...
    $string['HR12_desc'] = 'Custom Navigation Block on the Sidebar. Custom Text Block on the Sidebar.<br /><img src="'.$siteurl.'/theme/space/doc/sidebar-customnav.png" class="img-fluid rounded mt-3" /><br /><br /><hr /><div class="small">You can also add additional navigation using in-build moodle field. <br /><strong><Go to:</strong> Dashboard → Site administration → Appearance → Themes → Theme settings → <strong>Scroll to:</strong> Custom menu items</div><br /><img src="'.$siteurl.'/theme/space/doc/sidebar-customnav-2.png" class="img-fluid rounded" />';

    $string['HR13'] = '<div class="d-block text-center"><br /><hr/><br />Custom Text</div>';
    $string['HR13_desc'] = 'Custom Text Block on the Sidebar.<br /><img src="'.$siteurl.'/theme/space/doc/sidebar-custom-html.png" class="img-fluid rounded mt-3" />';

    $string['HR14'] = '<div class="d-block text-center"><br /><br />Categories</div>';
    $string['HR14_desc'] = 'Single Column HTML Block on the front page.<br /><img src="'.$siteurl.'/theme/space/doc/fp-block6.png" class="img-fluid rounded mt-3" />';

    $string['HR15'] = '<div class="d-block text-center"><br /><br />Sidebar</div>';
    $string['HR15_desc'] = '<div class="small">You can add custom logo below or go to: Dashboard → Site administration → Appearance → Logos.</div><br /><img src="'.$siteurl.'/theme/space/doc/fp-block6.png" class="img-fluid rounded mt-3" />';

    $string['HRLogo'] = '<div class="d-block text-center"><br /><br />Logotypes</div>';
    $string['HRLogo_desc'] = 'You can add up to 30 logotypes on the front page.<br /><img src="'.$siteurl.'/theme/space/doc/fp-block-logos.png" class="img-fluid rounded mt-3" />';

    $string['HRTeam'] = '<div class="d-block text-center"><br /><br />Team</div>';
    $string['HRTeam_desc'] = 'You can add up to 60 team members on the front page. <br /><img src="'.$siteurl.'/theme/space/doc/fp-block-team.jpg" class="img-fluid rounded mt-3" />';

    $string['HRTopBar'] = '<div class="d-block text-center"><hr /><br />Top Bar Text</div>';
    $string['HRTopBar_desc'] = 'Custom text on the top bar.<br /><img src="'.$siteurl.'/theme/space/doc/topbar-info.png" class="img-fluid rounded mt-3" />';
    ...
    $string['HR16_desc'] = '<div class="small mb-0"><h5>Language menu:</h5><ul class="list-unstyled"><li>Go to: Dashboard → Site administration → Language → Language settings</li><li>Check: Display language menu</li><li>Save</li></ul></div><img src="'.$siteurl.'/theme/space/doc/topbar-lang.png" class="img-fluid rounded mt-3" /><br /><br /><div class="small mb-0"><h5>Search box:</h5><ul class="list-unstyled"><li>Go to: Dashboard → Site administration → Advanced features</li><li>Check Enable global search</li> <li>Save</li></ul></div><img src="'.$siteurl.'/theme/space/doc/topbar-search.png" class="img-fluid rounded mt-3" />';
    ...
    $string['HR23_desc'] = 'You can change position of each blocks on the front page.<br /><img src="'.$siteurl.'/theme/space/doc/simple-front-page-builder.png" class="img-fluid rounded mt-4" />';

    $string['HR24'] = '<div class="d-block text-center"><br /><br />Top Bar Styles</div>';
    $string['HR24_desc'] = '<br /><img src="'.$siteurl.'/theme/space/doc/topbar-styles.png" class="img-fluid rounded mt-3" />';

    $string['HR25'] = '<div class="d-block text-center"><hr /><br />Sidebar Colors</div>';
    $string['HR25_desc'] = '<br /><img src="'.$siteurl.'/theme/space/doc/sidebar-colors.png" class="img-fluid rounded mt-3" />';

    $string['HR26'] = '<div class="d-block text-center"><hr /><br />Theme Colors</div>';
    $string['HR26_desc'] = '<br /><img src="'.$siteurl.'/theme/space/doc/colors-blue-palette.png" class="img-fluid rounded mt-3" />';

    $string['HR27'] = '<div class="d-block text-center"><hr /><br />Yellow - Default Palette</div>';
    $string['HR27_desc'] = '<br /><img src="'.$siteurl.'/theme/space/doc/colors-yellow-palette.png" class="img-fluid rounded mt-3" />';

    $string['HR28'] = '<div class="d-block text-center"><hr /><br />Green - Default Palette</div>';
    $string['HR28_desc'] = '<br /><img src="'.$siteurl.'/theme/space/doc/colors-green-palette.png" class="img-fluid rounded mt-3" />';

    $string['HR29'] = '<div class="d-block text-center"><hr /><br />Purple - Default Palette</div>';
    $string['HR29_desc'] = '<br /><img src="'.$siteurl.'/theme/space/doc/colors-purple-palette.png" class="img-fluid rounded mt-3" />';

    $string['HR30'] = '<div class="d-block text-center"><hr /><br />Red - Default Palette</div>';
    $string['HR30_desc'] = '<br /><img src="'.$siteurl.'/theme/space/doc/colors-red-palette.png" class="img-fluid rounded mt-3" />';

    $string['HR31'] = '<div class="d-block text-center"><hr /><br />Gray - Default Palette</div>';
    $string['HR31_desc'] = '<br /><img src="'.$siteurl.'/theme/space/doc/colors-gray-palette.png" class="img-fluid rounded mt-3" />';

    $string['HR32'] = '<div class="d-block text-center"><div class="d-block text-center"><br />Button Primary</div>';
    $string['HR32_desc'] = '<br /><img src="'.$siteurl.'/theme/space/doc/colors-btn-primary.png" class="img-fluid rounded mt-3" /><br /><br /><small class="mr-2">Your button style (preview):</small> <div class="btn btn-primary">Button Primary</div>';

    $string['HR33'] = '<div class="d-block text-center"><hr /><br />Button Secondary</div>';
    $string['HR33_desc'] = '<br /><img src="'.$siteurl.'/theme/space/doc/colors-btn-secondary.png" class="img-fluid rounded mt-3" /><br /><br /><small class="mr-2">Your button style (preview):</small> <div class="btn btn-secondary">Button Secondary</div>';

    $string['HR34'] = '<div class="d-block text-center"><hr /><br />Button Reset</div>';
    $string['HR34_desc'] = '<br /><img src="'.$siteurl.'/theme/space/doc/colors-btn-reset.png" class="img-fluid rounded mt-3" /><br /><br /><small class="mr-2">Your button style (preview):</small> <div class="btn btn-reset">Button Reset</div>';

    $string['HR35'] = '<div class="d-block text-center"><hr /><br />Button Special</div>';
    $string['HR35_desc'] = '<br /><img src="'.$siteurl.'/theme/space/doc/colors-btn-special.png" class="img-fluid rounded mt-3" /><br /><br /><small class="mr-2">Your button style (preview):</small> <div class="btn btn-special">Button Special</div>';

    $string['HR36'] = '<div class="d-block text-center"><hr /><br />Card</div>';
    $string['HR36_desc'] = '<br /><img src="'.$siteurl.'/theme/space/doc/colors-card.png" class="img-fluid rounded mt-3" /><br /><br />';
    ...
    $string['HR38_desc'] = '<br /><img src="'.$siteurl.'/theme/space/doc/colors-footer.png" class="img-fluid rounded mt-3" /><br /><br />';
    ...
    $string['HR40_desc'] = '<br /><img src="'.$siteurl.'/theme/space/doc/general-course-card.jpg" class="img-fluid rounded mt-3" /><br /><br />';
    ...
    $string['HR45'] = '<div class="d-block text-center"><hr /><br />Customization<br />Color and Font Size</div><br /><img src="'.$siteurl.'/theme/space/doc/hero-customization.jpg" class="img-fluid rounded mt-3" alt="Hero Image"/><br />';
    $string['HR45_desc'] = '';
    ...
    $string['HR47_desc'] = '<br /><img src="'.$siteurl.'/theme/space/doc/colors-dropdown.png" class="img-fluid rounded mt-3" /><br /><br />';
    ...
    $string['HR50'] = '<div class="d-block text-center"><hr /><br />Custom Modal</div><br /><img src="'.$siteurl.'/theme/space/doc/custommodal.png" class="img-fluid rounded mt-3" alt="Custom Modal"/>';
    $string['HR50_desc'] = '<br />';

    $string['HR51'] = '<div class="d-block text-center"><hr /><br />Calendar Events Color</div><br /><img src="'.$siteurl.'/theme/space/doc/calendar.png" class="img-fluid rounded mt-3" alt="Custom Modal"/>';
    $string['HR51_desc'] = '<br />';
    ...
    $string['choosereadme'] = 'Space offers you the best Moodle experience ever. Friendly user experience and modern design will take your moodle website to the next level.
    <br>
    ...
    $string['configtitle'] = 'Space (1.13.2)';
    $string['nobootswatch'] = 'None';
    $string['pluginname'] = 'Space (1.13.2)';
    ...
    ***/
    ...
    $string['region-sidebar'] = 'Nav Sidebar (Bottom)';
    $string['region-sidebar-top'] = 'Nav Sidebar (Top)';
...
&lt;/ul&gt;</code></pre>';
 ...
 &lt;/ul&gt;</code></pre>';
    ...
    ***/
    ...
    $string['customtopnavhtml_desc'] = '<img src="'.$siteurl.'/theme/space/doc/topbar-custom-nav-1.png" class="img-fluid rounded my-3" /> Example:<br /><pre><code>&#x3C;nav class=&#x22;navbar p-0&#x22;&#x3E;
      &#x3C;ul class=&#x22;navbar-nav&#x22;&#x3E;
        ...
        &#x3C;li class=&#x22;nav-item dropdown&#x22;&#x3E;
          ...
          &#x3C;div class=&#x22;dropdown-menu dropdown-menu-light&#x22; aria-labelledby=&#x22;navbarDropdown&#x22;&#x3E;
            ...
            &#x3C;div class=&#x22;d-inline-flex&#x22;&#x3E;
                        &#x3C;div class=&#x22;mr-2&#x22;&#x3E;&#x3C;img src=&#x22;https://s3.envato.com/files/256976677/space-moodle-theme.png&#x22; class=&#x22;icon&#x22;&#x3E;&#x3C;/div&#x3E;
...
&#x3C;/div&#x3E;</code></pre>
  <hr class="hr-bold" />';
    ...
    ***/
    ...
    $string['ShowCustomNav_desc'] = 'Select to trun on custom navigation on the top bar.<br /><img src="'.$siteurl.'/theme/space/doc/topbar-custom-nav.png" class="img-fluid rounded mt-3" />';
...
&#x3C;/div&#x3E;</code></pre>';
    ...
    $string['showsociallist_desc'] = 'Check this field to show up social icons list.<br /><img src="'.$siteurl.'/theme/space/doc/footer-social.png" class="img-fluid rounded mt-3" />';
...
&#x3C;/li&#x3E;</code></pre>';
    ...
    $string['CustomAlert_desc'] = 'Turn on custom alert. Show up once per session. You can use it as cookie alert. <br /><img src="'.$siteurl.'/theme/space/doc/customalert.png" class="img-fluid rounded mt-3" alt="Custom Alert" />';
    ...
    $string['hintro'] = '<div class="d-block text-center"><br /><br />Space Moodle Theme<br /><small>by Rosea Themes</small><br /><div class="badge badge-info">version 1.13.2</div>';
    ...
    $string['h4fontsize_desc'] = '<span class="badge badge-secondary"><strong>Example:</strong> 1.25rem</span>';
    ...
    ***/
    ...
    $string['hfpblock10_desc'] = '<strong>FAQ block</strong>. You can add up to 60 questions and answers.<br /><br /><img src="'.$siteurl.'/theme/space/doc/space-settings-block10.png" class="img-fluid rounded mt-4" />';
    ...
    ***/
    ...
    $string['hfpblock11_desc'] = 'Custom Course List on the front page. Up to 200 courses.<br /><img src="'.$siteurl.'/theme/space/doc/space-settings-block11.jpg" class="img-fluid rounded mt-4" />';
...
&#x3C;/div&#x3E;</code></pre>
    ...
    ***/
    ...
    $string['hfpblock12_desc'] = '<strong>Testimonials</strong>. Testimonials on the front page. Up to 60.<br /><img src="'.$siteurl.'/theme/space/doc/space-settings-block12.png" class="img-fluid rounded mt-4" />';
...
&#x3C;/div&#x3E;
    ...
    $string['privacy:metadata:preference:draweropenmycourse'] = 'The user\'s preference for hiding or showing the drawer menu navigation.';
    $string['privacy:draweraccordionclosed'] = 'The current preference for the navigation drawer is closed.';
    $string['privacy:draweraccordionopen'] = 'The current preference for the navigation drawer is open.';
