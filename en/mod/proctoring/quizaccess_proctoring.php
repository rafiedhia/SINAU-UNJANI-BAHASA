...
$string['proctoringlabel'] = '<p style="color:red">I agree with the validation process.</p>';
...
$string['settingscontroll:deleteall'] = 'Additional settings';
...
$string['settings:deleteallformlabel'] = '';
$string['settings:deleteallconfirm'] = 'Do you want to leave this page?';
...
$string['modal:speedtest'] = 'Tes Kecepatan Internet';
$string['modal:speed'] = 'calculating...';
$string['modal:internetspeed'] = 'Internet Speed:';