...
/**
 * Strings for component 'enrol_manual', language 'id', version '4.0'.
 *
...
$string['expirymessageenrolledbody'] = 'Halo {$a->user},

Ini adalah pemberitahuan bahwa pendaftaran Anda dalam kursus \'{$a->course}\' akan berakhir pada {$a->timeend}.
...
$string['expirymessageenrollerbody'] = 'Pendaftaran dalam kursus \'{$a->course}\' akan berakhir dalam {$a->threshold} berikutnya untuk pengguna berikut:
...
$string['pluginname_desc'] = 'Pengaya pendaftaran manual memungkinkan pengguna untuk didaftarkan secara manual melalui tautan di setelan administrasi kursus, oleh pengguna dengan izin yang sesuai seperti pengajar. Biasanya pengaya harus diaktifkan, karena pengaya tertentu lainnya, seperti pendaftaran mandiri, memerlukannya.';
