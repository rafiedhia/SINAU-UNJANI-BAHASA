...
/**
 * Strings for component 'media_videojs', language 'id', version '4.0'.
 *
...
$string['configaudioextensions'] = 'Daftar ekstensi berkas audio yang didukung yang dipisahkan koma. VideoJS akan mencoba menggunakan pemutar video asli peramban jika tersedia atau fungsionalitas VideoJS asli.';
...
$string['configvideoextensions'] = 'Daftar ekstensi berkas video yang didukung yang dipisahkan koma. VideoJS akan mencoba menggunakan pemutar video asli peramban jika tersedia.';
...
$string['pluginname_help'] = 'Pembungkus JavaScript untuk berkas video yang diputar oleh pemutar video asli permban. (Dukungan format tergantung pada peramban.)';
