...
/**
 * Strings for component 'error', language 'id', version '4.0'.
 *
 * @package     error
 * @category    string
...
$string['cannotgeoplugin'] = 'Tidak dapat terhubung ke server geoPlugin di https://www.geoplugin.com. Silakan periksa setelan proksi Anda atau pasang berkas data MaxMind GeoLite City.';
...
$string['cannotswitcheditmodeon'] = 'Tidak dapat mengaktifkan mode edit';
...
$string['serverconnection'] = 'Gagal tersembung ke server';
