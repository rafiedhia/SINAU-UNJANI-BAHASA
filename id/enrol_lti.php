...
/**
 * Strings for component 'enrol_lti', language 'id', version '4.0'.
 *
 * @package     enrol_lti
 * @category    string
...
$string['registrationendpoints'] = 'Titik akhir pendaftaran';
...
$string['registrationurlcannotgenerate'] = 'Anda harus menggunakan atau menghapus URL pendaftaran saat ini sebelum Anda dapat membuat yang baru.';
$string['registrationurldeleteconfirm'] = 'Hapus URL pendaftaran';
$string['registrationurldeleted'] = 'URL pendaftaran dihapus';
$string['registrationurldeletetitle'] = 'Hapus URL pendaftaran';
