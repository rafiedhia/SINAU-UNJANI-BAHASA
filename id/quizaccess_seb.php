...
/**
 * Strings for component 'quizaccess_seb', language 'id', version '4.0'.
 *
...
$string['filemanager_sebconfigfile'] = 'Unggah Konfigurasi "Safe Exam Browser"';
...
$string['seb_allowreloadinexam'] = 'Aktifkan muat ulang saat ujian';
...
$string['seb_linkquitseb_help'] = 'Di ruas ini Anda dapat memasukkan tautan untuk keluar dari SEB. Ini akan digunakan pada tombol "Keluar dari Safe Exam Browser" pada halaman yang muncul setelah ujian diserahkan. Saat mengklik tombol atau tautan yang ditempatkan di mana pun Anda ingin meletakkannya, dimungkinkan untuk keluar dari SEB tanpa harus memasukkan kata sandi berhenti. Jika tidak ada tautan yang dimasukkan, maka tombol "Keluar dari Safe Exam Browser" tidak akan muncul dan tidak ada tautan yang disetel untuk keluar dari SEB.';
