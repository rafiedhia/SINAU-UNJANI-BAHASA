...
/**
 * Strings for component 'block_completionstatus', language 'id', version '4.0'.
 *
...
$string['completionprogressdetails'] = 'Detail progres penyelesaian';
$string['completionstatus:addinstance'] = 'Tambahkan blok status penyelesaian kursus';
