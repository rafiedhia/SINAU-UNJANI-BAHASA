...
/**
 * Strings for component 'cachestore_redis', language 'id', version '4.0'.
 *
...
$string['task_ttl'] = 'Kosongkan memori yang digunakan oleh entri yang kedaluwarsa di cache Redis';
...
$string['test_ttl_desc'] = 'Jalankan uji kinerja menggunakan tembolok yang memerlukan TTL (set yang lebih lambat).';
