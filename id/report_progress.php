...
/**
 * Strings for component 'report_progress', language 'id', version '4.0'.
 *
...
$string['activityorder'] = 'Urutan aktivitas';
$string['allactivitiesandresources'] = 'Semua aktivitas dan sumber';
$string['alphabetical'] = 'Alfabetis';
$string['include'] = 'Sertakan';
$string['orderincourse'] = 'Urutkan di kursus';
