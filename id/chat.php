...
/**
 * Strings for component 'chat', language 'id', version '4.0'.
 *
 * @package     chat
 * @category    string
...
* Seorang siswa untuk sementara tidak dapat hadir secara langsung mengobrol dengan guru mereka untuk menyelesaikan pekerjaan
* Siswa yang sedang mencari pengalaman kerja berkumpul untuk mendiskusikan pengalaman mereka satu sama lain dan guru mereka
...
* Sesi untuk membantu siswa mempersiapkan ujian di mana guru, atau siswa lain, akan mengajukan contoh pertanyaan';
