...
/**
 * Strings for component 'completion', language 'id', version '4.0'.
 *
 * @package     completion
 * @category    string
...
$string['activitygradetopassnotset'] = 'Aktivitas ini tidak memiliki nilai yang valid untuk lulus. Ini dapat diatur di bagian Penilaian pada pengaturan aktivitas.';
...
$string['completionpassgrade_desc'] = 'Siswa harus menerima nilai kelulusan untuk menyelesaikan kegiatan ini';
$string['completionpassgrade_help'] = 'Jika diaktifkan, aktivitas dianggap selesai saat siswa menerima nilai kelulusan.';
...
$string['coursecompletion'] = 'Penyelesaian Mata Kuliah';
...
$string['detail_desc:receivepassgrade'] = 'Menerima nilai kelulusan';
...
$string['enablecompletion_help'] = 'Jika diaktifkan, ketentuan penyelesaian aktivitas dapat diatur pada setelan aktivitas dan/atau ketentuan penyelesaian mata kuliah dapat diatur. Direkomendasikan untuk diaktifkan sehingga data dapat ditampilkan dalam ikhtisar mata kuliah di Dasbor.';
...
$string['showcompletionconditions'] = 'Tampilkan ketentuan penyelesaian aktivitas';
$string['showcompletionconditions_help'] = 'Ketentuan penyelesaian aktivitas selalu ditampilkan di halaman aktivitas. Setelan ini juga menentukan apakah ketentuan penyelesaian aktivitas ditampilkan di bawah setiap aktivitas pada halaman mata kuliah.';
