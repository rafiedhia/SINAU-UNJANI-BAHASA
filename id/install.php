...
/**
 * Strings for component 'install', language 'id', version '4.0'.
 *
 * @package     install
 * @category    string
...
$string['clisupportemail'] = 'Alamat surel dukungan';
...
<p> Nama basis data hanya boleh berisi karakter alfanumerik, dollar ($) dan garis bawah (_). </p>
