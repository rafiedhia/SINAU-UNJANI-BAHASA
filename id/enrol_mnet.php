...
/**
 * Strings for component 'enrol_mnet', language 'id', version '4.0'.
 *
 * @package     enrol_mnet
 * @category    string
...
$string['mnet_enrol_description'] = 'Publikasikan layanan ini untuk memungkinkan administrator di {$a} mendaftarkan siswanya ke kursus yang telah Anda buat di server Anda. <br/> <ul><li> <em> Ketergantungan </em>: Anda juga harus <strong> berlangganan </strong> ke layanan SSO (Identity Provider) di {$a}. </li> <li> <em> Ketergantungan </em>: Anda juga harus <strong> mempublikasikan </strong> layanan SSO (Penyedia Layanan) ke {$a}. </li> </ul> <br/> Berlangganan ke layanan ini untuk dapat mendaftarkan siswa Anda ke kursus di {$a}. <br/> <ul><li> <em> Ketergantungan </em>: Anda juga harus <strong> mempublikasikan </strong> layanan SSO (Penyedia Identitas) ke {$a}. </li> <li> <em> Ketergantungan </em>: Anda juga harus <strong> berlangganan </strong> ke layanan SSO (Penyedia Layanan) di {$a}. </li> </ul> <br/>';
