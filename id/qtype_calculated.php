...
/**
 * Strings for component 'qtype_calculated', language 'id', version '4.0'.
 *
...
$string['privacy:metadata'] = 'Pengaya jenis soal terhitung tidak menyimpan data pribadi apa pun.';
