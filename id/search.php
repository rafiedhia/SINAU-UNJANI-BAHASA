...
/**
 * Strings for component 'search', language 'id', version '4.0'.
 *
 * @package     search
 * @category    string
...
$string['content:courserole'] = '{$a->role} pada {$a->course}';
$string['core-all'] = 'Semua';
$string['core-course-content'] = 'Konten kursus';
$string['core-courses'] = 'Mata Kuliah';
...
$string['search:course'] = 'Mata Kuliah';
$string['search:course_teacher'] = 'Pengajar Kursus';
...
$string['topresults'] = 'Hasil Teratas';
