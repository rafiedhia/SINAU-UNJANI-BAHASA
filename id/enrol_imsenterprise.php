...
/**
 * Strings for component 'enrol_imsenterprise', language 'id', version '4.0'.
 *
...
$string['processphotowarning'] = 'Peringatan: Pemrosesan gambar kemungkinan akan menambah beban yang signifikan ke server. Anda disarankan untuk tidak mengaktifkan opsi ini jika diharapkan sejumlah besar siswa akan diproses.';
...
$string['settingshortname'] = 'Tag deskripsi IMS untuk nama singkat kursus';
$string['settingshortnamedescription'] = 'Nama singkat adalah bidang kursus wajib sehingga Anda harus menentukan tag deskripsi yang dipilih di berkas IMS Enterprise Anda';
