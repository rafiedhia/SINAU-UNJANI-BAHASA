...
/**
 * Strings for component 'lti', language 'id', version '4.0'.
 *
 * @package     lti
 * @category    string
...
$string['default_launch_container_help'] = 'Wadah peluncuran memengaruhi tampilan alat saat diluncurkan dari kursus. Beberapa wadah peluncuran menyediakan lebih banyak layar real estat ke alat, dan yang lain memberikan nuansa yang lebih terintegrasi dengan lingkungan Moodle. * **Bawaan** - Gunakan wadah peluncuran yang ditentukan oleh konfigurasi alat. * **Tanamkan** - Alat ini ditampilkan dalam jendela Moodle yang ada, dengan cara yang mirip dengan sebagian besar jenis Aktivitas lainnya. * **Sematkan, tanpa blok** - Alat ditampilkan dalam jendela Moodle yang ada, hanya dengan kontrol navigasi di bagian atas halaman. * **Jendela baru** - Alat ini terbuka di jendela baru, menempati semua ruang yang tersedia. Tergantung pada browser, itu akan terbuka di tab baru atau jendela popup. Ada kemungkinan bahwa peramban akan mencegah jendela baru dibuka.';
