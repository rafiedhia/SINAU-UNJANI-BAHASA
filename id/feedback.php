...
/**
 * Strings for component 'feedback', language 'id', version '4.0'.
 *
 * @package     feedback
 * @category    string
...
$string['feedbackclose'] = 'Izinkan jawaban kepada';
...
$string['modulename_help'] = 'Modul aktivitas umpan balik memungkinkan pengajar membuat survei tersuai untuk mengumpulkan umpan balik dari peserta menggunakan berbagai jenis pertanyaan termasuk pilihan ganda, ya/tidak, atau input teks.
...
$string['whatfor'] = 'Apa yang ingin Anda lakukan?';
