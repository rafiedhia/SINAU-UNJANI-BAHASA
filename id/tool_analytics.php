...
/**
 * Strings for component 'tool_analytics', language 'id', version '4.0'.
 *
...
$string['importmodel'] = 'Impor model';
...
$string['loginfo'] = 'Info log ekstra';
...
$string['trainmodels'] = 'Model pelatihan';
