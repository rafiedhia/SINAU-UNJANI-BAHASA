...
/**
 * Strings for component 'tool_unsuproles', language 'id', version '4.0'.
 *
...
$string['confirmdelete'] = 'Anda yakin ingin menghapus semua penetapan peran yang tidak didukung untuk peran "{$a->role}" di level konteks "{$a->level}"?';
