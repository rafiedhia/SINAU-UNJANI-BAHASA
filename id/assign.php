...
/**
 * Strings for component 'assign', language 'id', version '4.0'.
 *
 * @package     assign
 * @category    string
...
$string['addsubmission'] = 'Tambahkan pengumpulan';
...
$string['caneditsubmission'] = 'Anda dapat mengirimkan/mengedit ajuan setelah batas waktu berlalu, tetapi akan ditandai sebagai terlambat.';
...
$string['confirmstart'] = 'Kiriman Anda akan memiliki batas waktu {$a}. Saat Anda mulai, penghitung waktu akan mulai menghitung mundur dan tidak dapat dijeda. Anda harus menyelesaikan pengajuan Anda sebelum kedaluwarsa. Apakah Anda yakin ingin memulainya sekarang?';
...
$string['eventgradingtableviewed'] = 'Modul Mata Kuliah Dilihat';
...
$string['introattachments_help'] = 'Berkas tambahan untuk digunakan dalam penugasan, seperti templat jawaban, dapat ditambahkan. Tautan unduhan untuk berkas kemudian akan ditampilkan pada halaman penugasan di bawah deskripsi aktivitas.';
...
$string['nosubmissionyet'] = 'Belum ada pengumpulan tugas';
...
$string['notgradedyet'] = 'Perlu Dinilai';
...
$string['submissionattachments_help'] = 'Saat diaktifkan, berkas hanya akan ditampilkan di layar pengajuan. Ketika berkas dinonaktifkan akan ditampilkan pada kedua tampilan tugas dan layar pengajuan.';
...
$string['submittedovertime'] = 'Tugas diajukan {$a} melebihi batas waktu';
$string['submittedundertime'] = 'Tugas diajukan {$a} di bawah batas waktu';
...
$string['timelimitpassed'] = 'Batas waktu telah berlalu';
$string['timemodified'] = 'Alamat IP Terakhir';
