...
/**
 * Strings for component 'enrol_database', language 'id', version '4.0'.
 *
...
$string['dbencoding'] = 'Pengodean basis data';
$string['dbhost'] = 'Hos basis data';
$string['dbhost_desc'] = 'Ketik alamat IP server basis data atau nama hos. Gunakan nama DSN sistem jika menggunakan ODBC. Gunakan PDO DSN jika menggunakan PDO.';
...
$string['dbsetupsql_desc'] = 'Perintah SQL untuk setelan basis data khusus, sering digunakan untuk mengatur pengodean komunikasi - contoh untuk MySQL dan PostgreSQL: <em> SET NAMES \'utf8\' </em>';
...
$string['ignorehiddencourses'] = 'Lewati mata kuliah tersembunyi';
...
$string['newcourseshortname'] = 'Ruas nama singkat kursus baru';
...
$string['privacy:metadata'] = 'Pengaya pendaftaran basis data eksternal tidak menyimpan data pribadi apa pun.';
