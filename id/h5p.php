...
/**
 * Strings for component 'h5p', language 'id', version '4.0'.
 *
 * @package     h5p
 * @category    string
...
$string['h5plibraryhandler'] = 'Yang menangani kerangka H5P';
$string['h5plibraryhandler_help'] = 'Kerangka H5P digunakan untuk menampilkan konten H5P. Versi terbaru direkomendasikan.';
...
$string['installedcontentlibraries'] = 'Pustaka H5P Terpasang';
$string['installedcontenttypes'] = 'Jenis Konten H5P Terpasang';
...
$string['task_h5p_description'] = 'Fitur tugas terjadwal H5P mengunduh jenis konten H5P yang tersedia dari h5p.org.';
