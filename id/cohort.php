...
/**
 * Strings for component 'cohort', language 'id', version '4.0'.
 *
 * @package     cohort
 * @category    string
...
$string['cohort'] = 'Kohor';
$string['cohortmember'] = 'Anggota kohor';
...
$string['idnumber'] = 'ID Kelompok dengan Kategori Tertentu';
$string['invalidtheme'] = 'Tema kohor tidak ada';
$string['memberofcohort'] = 'Anggota kohor';
...
$string['privacy:metadata:cohort_members:cohortid'] = 'ID Kelompok dengan Kategori Tertentu';
