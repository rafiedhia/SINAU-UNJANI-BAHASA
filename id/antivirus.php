...
/**
 * Strings for component 'antivirus', language 'id', version '4.0'.
 *
 * @package     antivirus
 * @category    string
...
$string['dataerrordesc'] = 'Terjadi kesalahan pemindai data.';
$string['dataerrorname'] = 'Kesalahan pemindai data';
...
$string['fileerrordesc'] = 'Terjadi kesalahan pemindai berkas.';
$string['fileerrorname'] = 'Kesalahan pemindai berkas';
...
$string['notifylevel'] = 'Tingkat pemberitahuan';
$string['notifylevel_help'] = 'Berbagai tingkat informasi yang ingin Anda beri tahu';
$string['notifylevelerror'] = 'Terdeteksi ancaman dan kesalahan pemindai';
$string['notifylevelfound'] = 'Hanya ancaman yang terdeteksi';
...
$string['threshold'] = 'Ambang batas untuk pemeriksaan status';
$string['threshold_desc'] = 'Seberapa jauh ke belakang untuk memeriksa hasil sebelumnya untuk kesalahan dll. seperti yang dilaporkan dalam {$a}.';
