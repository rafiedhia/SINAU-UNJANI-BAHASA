...
/**
 * Strings for component 'data', language 'id', version '4.0'.
 *
 * @package     data
 * @category    string
...
$string['authorfirstname'] = 'Nama depan pengarang';
...
$string['emptyaddform'] = 'Anda tidak mengisi ruas apa pun!';
...
$string['fields'] = 'Ruas';
$string['fieldsnavigation'] = 'Ruas navigasi tersier';
...
$string['foundrecords'] = 'Catatan yang ditemukan: {$a->num}/{$a->max} (<a href="{$a->reseturl} "> Setel ulang filter </a>)';
...
$string['norecords'] = 'Tidak ada entri dalam basis data';
...
$string['requireapproval_help'] = 'Jika diaktifkan, entri memerlukan persetujuan pengajar sebelum dapat dilihat oleh semua orang.';
...
$string['savedataaspreset'] = 'Simpan semua ruas dan templat sebagai preset';
