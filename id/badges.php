...
/**
 * Strings for component 'badges', language 'id', version '4.0'.
 *
 * @package     badges
 * @category    string
...
$string['allowcoursebadges_desc'] = 'Izinkan lencana dibuat dan diberikan dalam konteks mata kuliah';
$string['allowexternalbackpack'] = 'Koneksi Ransel Eksternal';
$string['allowexternalbackpack_desc'] = 'Jika diaktifkan, pengguna dapat terhubung ke ransel eksternal dan membagikan lencana mereka dari situs ini. Pengguna juga dapat memilih untuk menampilkan koleksi lencana publik dari ransel eksternal mereka di halaman profil mereka di situs ini. Sebaiknya biarkan opsi ini dinonaktifkan jika situs Anda tidak dapat diakses dari Internet.';
$string['any'] = 'Apa pun';
...
$string['criteria_4'] = 'Penyelesaian Mata Kuliah';
...
$string['defaultissuerpassword_help'] = 'Akun diperlukan di situs ransel dengan alamat surel seperti yang ditentukan dalam pengaturan alamat surel penerbit lencana di administrasi Situs/Lencana/Setelan Lencana. Kata sandi untuk akun tersebut harus dimasukkan di sini.';
...
$string['issuancedetails'] = 'Waktu Kedaluwarsa Lencana';
...
$string['sitebackpack_help'] = 'Ransel eksternal yang dapat dihubungkan pengguna dari situs ini. Perhatikan bahwa mengubah setelan ini setelah pengguna menghubungkan ransel mereka akan mengharuskan setiap pengguna untuk membuka halaman setelan ransel mereka dan memutuskan sambungan kemudian menyambung kembali.';
