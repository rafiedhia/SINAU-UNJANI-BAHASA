...
/**
 * Strings for component 'block', language 'id', version '4.0'.
 *
 * @package     block
 * @category    string
...
$string['createdat_help'] = 'Lokasi asli tempat blok dibuat. Pengaturan blok dapat menyebabkannya muncul di lokasi lain (konteks) dalam lokasi asli. Misalnya, blok yang dibuat pada halaman kursus dapat ditampilkan dalam aktivitas dalam kursus itu. Blok yang dibuat di beranda situs dapat ditampilkan di seluruh situs.';
...
$string['deleteblockcheck'] = 'Apakah Anda yakin menghapus blok berjudul {$a}?';
$string['deleteblockinprogress'] = 'Blok {$a} saat ini sedang dihapus dari halaman ini.';
