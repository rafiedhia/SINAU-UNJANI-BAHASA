...
/**
 * Strings for component 'tool_usertours', language 'id', version '4.0'.
 *
...
$string['content_type_help'] = 'Jenis konten terdiri:

* Baca dari paket bahasa - ID string bahasa dapat dimasukkan dalam pengenal format,komponen (tanpa tanda kurung atau spasi setelah koma).
* Masuk secara manual - Menggunakan editor untuk memasukkan konten';
...
$string['endtourlabel_help'] = 'Anda dapat secara opsional menentukan label khusus untuk tombol akhiri tur. Label default adalah "Mengerti" untuk satu langkah, dan "Akhiri tur" untuk tur beberapa langkah..
...
$string['filter_course'] = 'Mata Kuliah';
...
$string['invalid_lang_id'] = 'Pengidentifikasi bahasa tidak valid';
$string['left'] = 'Kiri';
...
$string['previousstep'] = 'Sebelumnya';
...
$string['tour3_title_overview'] = 'Ikhtisar Mata Kuliah';
...
$string['tour4_content_groupconvo'] = 'Jika Anda adalah anggota grup dengan olah pesan grup diaktifkan, Anda akan melihat percakapan grup di sini. Percakapan kelompok kursus memungkinkan Anda untuk berinteraksi dengan orang lain dalam kelompok Anda di lokasi yang pribadi dan nyaman.';
