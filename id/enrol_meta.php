...
/**
 * Strings for component 'enrol_meta', language 'id', version '4.0'.
 *
 * @package     enrol_meta
 * @category    string
...
$string['wsinvalidcourse'] = 'ID kursus = {$a} tidak ada atau tidak ada izin untuk menautkan dalam pendaftaran meta.';
$string['wsinvalidmetacourse'] = 'ID kursus meta = {$a} tidak ada atau tidak ada izin untuk menambahkan model pendaftaran.';
