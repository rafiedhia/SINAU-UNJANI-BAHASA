...
/**
 * Strings for component 'quiz_overview', language 'id', version '4.0'.
 *
...
$string['regradealldrydo'] = 'Pengerjaan kuis yang ditandai perlu penilaian ulang ({$a})';
$string['regradealldrydogroup'] = 'Nilai ulang pengerjaan kuis ({$a->countregradeneeded}) ditandai perlu penilaian ulang dalam grup \'{$a->groupname}\'';
...
$string['regradeselected'] = 'Nilai ulang pengerjaan kuis terpilih';
