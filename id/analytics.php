...
/**
 * Strings for component 'analytics', language 'id', version '4.0'.
 *
 * @package     analytics
 * @category    string
...
$string['defaultpredictionsprocessor'] = 'Prosesor Prediksi Bawaan';
...
$string['levelinstitution'] = 'Jenjang Pendidikan';
...
$string['modeinstruction'] = 'Moda Pembelajaran';
$string['modeinstructionblendedhybrid'] = 'Hibrida';
$string['modeinstructionfacetoface'] = 'Tatap Muka';
$string['modeinstructionfullyonline'] = 'Daring';
...
$string['typeinstitution'] = 'Jenis Institusi';
