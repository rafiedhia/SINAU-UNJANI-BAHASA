...
/**
 * Strings for component 'enrol', language 'id', version '4.0'.
 *
 * @package     enrol
 * @category    string
...
$string['custominstancename'] = 'Nama model tersuai';
$string['defaultenrol'] = 'Tambahkan model ke kursus baru';
...
$string['deleteinstanceconfirmself'] = 'Apakah Anda yakin untuk menghapus model "{$a->name}" yang memberikan Anda akses ke kursus ini? Kemungkinan Anda tidak akan bisa mengakses kursus ini jika dilanjutkan menghapus.';
$string['deleteinstancenousersconfirm'] = 'Anda akan menghapus metode pendaftaran "{$a->name}". Apakah Anda yakin untuk melanjutkan?';
$string['disableinstanceconfirmself'] = 'Apakah Anda yakin untuk menonaktifkan model "{$a->name}" yang memberikan Anda akses ke kursus ini? Dimungkinkan Anda tidak akan bisa mengakses kursus ini jika dilanjutkan menghapus.';
...
$string['errorenrolcohort'] = 'Galat dalam membuat model pendaftaran sinkronisasi kohor dalam kursus ini.';
...
$string['eventenrolinstanceupdated'] = 'Memperbarui instance pendaftaran';
...
$string['unenrolme'] = 'Keluarkan saya dari {$a}';
