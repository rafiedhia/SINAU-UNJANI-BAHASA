...
/**
 * Strings for component 'plugin', language 'id', version '4.0'.
 *
 * @package     plugin
 * @category    string
...
$string['type_mod'] = 'Modul Kegiatan';
$string['type_mod_plural'] = 'Modul Kegiatan';
...
$string['type_qbank'] = 'Pengaya bank soal';
$string['type_qbank_plural'] = 'Pengaya bank soal';
