...
/**
 * Strings for component 'book', language 'id', version '4.0'.
 *
 * @package     book
 * @category    string
...
$string['numbering_help'] = '* Tidak ada - Judul bab dan sub bab tidak memiliki format * Nomor - Bab dan judul sub bab diberi nomor 1, 1.1, 1.2, 2, ... * Poin - Subbab diindentasi dan ditampilkan dengan poin di daftar isi * Indentasi - Subbab diberi menjorok ke dalam daftar isi';
