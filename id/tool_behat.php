...
/**
 * Strings for component 'tool_behat', language 'id', version '4.0'.
 *
 * @package     tool_behat
 * @category    string
...
$string['erroruniqueconfig'] = 'Nilai $CFG->behat_dataroot, $CFG->behat_prefix dan $CFG->behat_wwwroot harus berbeda dari $CFG->dataroot, $CFG->prefix, $CFG->wwwroot, $CFG->phpunit_dataroot dan $CFG- > nilai phpunit_prefix. <br/>Atau, jika $CFG->behat_prefix sama, $CFG->behat_dbname atau $CFG->behat_dbhost harus berbeda dari $CFG->phpunit_dbname dan $CFG->phpunit_dbhost dan dari $CFG->dbname dan $CFG->dbhost.';
...
$string['stepsdefinitionstype'] = 'Jenis';
$string['theninfo'] = 'Kemudian. Pemeriksaan untuk memastikan capaian sesuai dengan yang diharapkan';
$string['unknownexceptioninfo'] = 'Ada masalah dengan Selenium atau server Anda. Harap pastikan Anda menggunakan Selenium versi terbaru. Galat:';
