...
/**
 * Strings for component 'scorm', language 'id', version '4.0'.
 *
 * @package     scorm
 * @category    string
...
$string['completionscorerequired_help'] = 'Mengaktifkan setelan ini akan mengharuskan pengguna memiliki setidaknya nilai minimum yang dimasukkan untuk ditandai sebagai selesai dalam aktivitas SCORM ini, serta persyaratan Kelengkapan Aktivitas lainnya.';
