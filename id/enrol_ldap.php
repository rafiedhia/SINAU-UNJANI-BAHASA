...
/**
 * Strings for component 'enrol_ldap', language 'id', version '4.0'.
 *
 * @package     enrol_ldap
 * @category    string
...
$string['cannotupdatecourse_duplicateshortname'] = 'Tidak dapat memperbarui kursus: Nama singkat duplikat. Lewati kursus dengan Nomor ID \'{$a->idnumber}\' ...';
...
$string['course_shortname_key'] = 'Nama singkat';
$string['course_shortname_updateonsync'] = 'Perbarui nama singkat selama skrip sinkronisasi';
$string['course_shortname_updateonsync_key'] = 'Perbarui nama singkat';
...
$string['duplicateshortname'] = 'Pembuatan kursus gagal. Nama singkat duplikat. Lewati kursus dengan nomor ID \'{$a->idnumber}\' ...';
...
$string['ldap_encoding'] = 'Tentukan pengodean yang digunakan oleh server LDAP. Kemungkinan besar utf-8, MS AD v2 menggunakan pengkodean platform bawaan seperti cp1252, cp1250, dll.';
$string['ldap_encoding_key'] = 'Pengodean LDAP';
...
$string['server_settings'] = 'Setelan server LDAP';
