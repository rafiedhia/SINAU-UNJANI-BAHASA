...
/**
 * Strings for component 'quiz', language 'id', version '4.0'.
 *
 * @package     quiz
 * @category    string
...
$string['allowreview'] = 'Izinkan ulasan';
...
$string['attemptgradeddelay'] = 'Tunda sebelum mengirim pemberitahuan upaya yang dinilai';
$string['attemptgradeddelay_desc'] = 'Penundaan diterapkan sebelum mengirim surel kepada siswa untuk memberi tahu mereka bahwa upaya kuis mereka sekarang telah dinilai. Ini adalah pertukaran. Kami ingin memberi tahu siswa sesegera mungkin. Namun, pengajar dapat kembali dan mengedit nilai lagi, dan kami tidak ingin memberi tahu siswa sebelum itu terjadi';
...
$string['backtocourse'] = 'Kembali ke menu';
...
$string['confirmclose'] = 'Apakah anda yakin akan menyelesaikan kuis ini? Jika iya maka anda tidak dapat mengubah jawaban kuis ini kembali.';
...
Anda akan dapat melihat skor dan umpan balik Anda dengan mengunjungi \'{$a->quizurl}\' dan meninjau upaya Anda.';
...
Anda dapat meninjau pengerjaan kuis ini di {$a->quizreviewurl}.';
...
$string['eventeditpageviewed'] = 'Halaman Edit Kuis Dilihat';
...
$string['noreviewattempt'] = 'Anda tidak diizinkan untuk mengulas hasil pengerjaan kuis ini.';
...
$string['notifyattemptsgradedtask'] = 'Kirim pemberitahuan tentang upaya kuis yang sekarang dinilai sepenuhnya';
