...
/**
 * Strings for component 'enrol_self', language 'id', version '4.0'.
 *
 * @package     enrol_self
 * @category    string
...
$string['customwelcomemessage_help'] = 'Pesan selamat datang tersuai dapat ditambahkan dalam bentuk teks biasa atau format otomatis Moodle, beserta tag html dan tag multi bahasa.
...
$string['groupkey_help'] = 'Selain membatasi akses ke kursus hanya bagi mereka yang mengetahui kunci, penggunaan kunci pendaftaran grup berarti pengguna secara otomatis ditambahkan ke grup ketika mereka mendaftar di kursus. Catatan: Kunci pendaftaran untuk kursus harus ditentukan dalam setelan pendaftaran sendiri serta kunci pendaftaran kelompok dalam setelan grup.';
