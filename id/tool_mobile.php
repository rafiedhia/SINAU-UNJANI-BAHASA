...
/**
 * Strings for component 'tool_mobile', language 'id', version '4.0'.
 *
 * @package     tool_mobile
 * @category    string
...
$string['qrkeyttl_desc'] = 'Lama waktu validitas kode QR untuk autentikasi. Nilai kosong tidak diperbolehkan, dalam hal ini nilai default untuk setelan akan digunakan.';
